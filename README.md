...
# vxla2json (Voxler Archive to JSON)

vxla2json is for converting Let's Sing and Dance VXLA files to Just Dance TAPE format to make them play-able.

# Requirements
  - Node.JS
  - Let's Sing and Dance (duh)

# How to use?

Welcome! Please run`run.bat` and follow the instructions.

Once you're done, your converted files will be under maps/*codename*/ folder.
